                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input id="slug" name="slug" value="{{ $product->slug }}" type="text"
                                                class="form-control" aria-required="true" aria-invalid="false" required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input id="image" name="image" value="{{ $product->image }}" type="file"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input id="brand" name="brand" value="{{ $product->brand }}" type="text"
                                                class="form-control" aria-required="true" aria-invalid="false" >
                                        </div>
                                        <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <input id="short_desc" name="short_desc" value="{{ $product->short_desc }}"
                                                type="text" class="form-control" aria-required="true" aria-invalid="false"
                                                >
                                        </div>
                                        <div class="col-md-4">
                                            <label for="desc" class="control-label mb-1">Description</label>
                                            <input id="desc" name="desc" value="{{ $product->desc }}" type="text"
                                                class="form-control" aria-required="true" aria-invalid="false" >
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <input id="technical_spacification" name="technical_spacification"
                                                value="{{ $product->technical_spacification }}" type="text" class="form-control"
